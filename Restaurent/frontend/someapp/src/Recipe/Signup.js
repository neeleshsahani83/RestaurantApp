...
function Signup() {
  ...
  return (
    ...
    <input type="text" className="form-control" /* id="exampleInputEmail1"  */aria-describedby="emailHelp" placeholder='Annie Sahani'  value={name}
  ...
  <div className="mb-3">
    ...
    <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder='dummy@gmail.com'  value={email}
